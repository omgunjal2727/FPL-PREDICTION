...
def clean_and_merge_fpl_data(fpl_23_24_path, fpl_24_25_path, epl_24_25_path):
    ...
    try:
        # Load the datasets
        df_23_24_fpl = pd.read_csv(fpl_23_24_path)
        df_24_25_fpl = pd.read_csv(fpl_24_25_path)
        df_24_25_epl = pd.read_csv(epl_24_25_path)
    ...
    # Select and rename historical columns to avoid clashes
    historical_cols = {
        'name': 'player_name',
        'team': 'team_name',
        'total_points': 'points_23_24',
        'minutes': 'minutes_23_24',
        'expected_goals': 'xg_23_24',
        'expected_assists': 'xa_23_24',
        'bps': 'bps_23_24',
        'bonus': 'bonus_23_24',
        'influence': 'influence_23_24',
        'creativity': 'creativity_23_24',
        'threat': 'threat_23_24'
    }
    ...
    df_24_25_epl.rename(columns={'Player Name': 'player_name', 'Club': 'team_name'}, inplace=True)
    ...
    print("\nMerging DataFrames...")
    # Merge current season FPL data with historical FPL data
    ...
    # Merge the result with the general EPL stats
    # We drop columns from the EPL stats that are already present in the FPL data to avoid duplication
    ...
    # --- 6. Final Cleanup ---
    # Fill NaN values for historical stats with 0 (for players new to the league)
    historical_nan_cols = ['points_23_24', 'minutes_23_24', 'xg_23_24', 'xa_23_24', 'bps_23_24', 'bonus_23_24', 'influence_23_24', 'creativity_23_24', 'threat_23_24']
...
# Make sure the CSV files are in the same directory as the script, or provide full paths.
...
if final_df is not None:
    ...
    # Using a well-known player to demonstrate the merged data
